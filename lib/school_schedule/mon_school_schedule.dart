...
class _MonDayScheduleScreenState extends State<MonDayScheduleScreen> {
  ...
  void _updateSchedule() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cập nhật thời khóa biểu thứ hai thành công!')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  void loadMondayData() async {
    ...
    if (data != null && data['monday'] != null) {
      setState(() {
        _subject1.text = data['monday']['subject1'] ?? '';
        _subject2.text = data['monday']['subject2'] ?? '';
        _subject3.text = data['monday']['subject3'] ?? '';
        _subject4.text = data['monday']['subject4'] ?? '';
        _subject5.text = data['monday']['subject5'] ?? '';
        _subject6.text = data['monday']['subject6'] ?? '';
        _subject7.text = data['monday']['subject7'] ?? '';
        _subject8.text = data['monday']['subject8'] ?? '';
        _subject9.text = data['monday']['subject9'] ?? '';
        _subject10.text = data['monday']['subject10'] ?? '';
        _subject11.text = data['monday']['subject11'] ?? '';
        _subject12.text = data['monday']['subject12'] ?? '';
      });
    }
  }
