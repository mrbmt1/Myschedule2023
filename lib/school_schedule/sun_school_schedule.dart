...
class SunDayScheduleScreen extends StatefulWidget {
  ...
  @override
  _SunDayScheduleScreenState createState() => _SunDayScheduleScreenState();
}

class _SunDayScheduleScreenState extends State<SunDayScheduleScreen> {
  ...
  void _updateSchedule() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cập nhật thời khóa biểu chủ nhật thành công!')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  void loadSundayData() async {
    ...
    if (data != null && data['sunday'] != null) {
      setState(() {
        _subject1.text = data['sunday']['subject1'] ?? '';
        _subject2.text = data['sunday']['subject2'] ?? '';
        _subject3.text = data['sunday']['subject3'] ?? '';
        _subject4.text = data['sunday']['subject4'] ?? '';
        _subject5.text = data['sunday']['subject5'] ?? '';
        _subject6.text = data['sunday']['subject6'] ?? '';
        _subject7.text = data['sunday']['subject7'] ?? '';
        _subject8.text = data['sunday']['subject8'] ?? '';
        _subject9.text = data['sunday']['subject9'] ?? '';
        _subject10.text = data['sunday']['subject10'] ?? '';
        _subject11.text = data['sunday']['subject11'] ?? '';
        _subject12.text = data['sunday']['subject12'] ?? '';
      });
    }
  }
