...
class _ThursDayScheduleScreenState extends State<ThursDayScheduleScreen> {
  ...
  void _updateSchedule() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cập nhật thời khóa biểu thứ năm thành công!')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  void loadThursdayData() async {
    ...
    if (data != null && data['thursday'] != null) {
      setState(() {
        _subject1.text = data['thursday']['subject1'] ?? '';
        _subject2.text = data['thursday']['subject2'] ?? '';
        _subject3.text = data['thursday']['subject3'] ?? '';
        _subject4.text = data['thursday']['subject4'] ?? '';
        _subject5.text = data['thursday']['subject5'] ?? '';
        _subject6.text = data['thursday']['subject6'] ?? '';
        _subject7.text = data['thursday']['subject7'] ?? '';
        _subject8.text = data['thursday']['subject8'] ?? '';
        _subject9.text = data['thursday']['subject9'] ?? '';
        _subject10.text = data['thursday']['subject10'] ?? '';
        _subject11.text = data['thursday']['subject11'] ?? '';
        _subject12.text = data['thursday']['subject12'] ?? '';
      });
    }
  }
