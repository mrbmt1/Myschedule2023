...
class TuesDayScheduleScreen extends StatefulWidget {
  ...
  @override
  _TuesDayScheduleScreenState createState() => _TuesDayScheduleScreenState();
}

class _TuesDayScheduleScreenState extends State<TuesDayScheduleScreen> {
  ...
  void _updateSchedule() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cập nhật thời khóa biểu thứ ba thành công!')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  void loadTuesdayData() async {
    ...
    if (data != null && data['tuesday'] != null) {
      setState(() {
        _subject1.text = data['tuesday']['subject1'] ?? '';
        _subject2.text = data['tuesday']['subject2'] ?? '';
        _subject3.text = data['tuesday']['subject3'] ?? '';
        _subject4.text = data['tuesday']['subject4'] ?? '';
        _subject5.text = data['tuesday']['subject5'] ?? '';
        _subject6.text = data['tuesday']['subject6'] ?? '';
        _subject7.text = data['tuesday']['subject7'] ?? '';
        _subject8.text = data['tuesday']['subject8'] ?? '';
        _subject9.text = data['tuesday']['subject9'] ?? '';
        _subject10.text = data['tuesday']['subject10'] ?? '';
        _subject11.text = data['tuesday']['subject11'] ?? '';
        _subject12.text = data['tuesday']['subject12'] ?? '';
      });
    }
  }
