...
class SaturDayScheduleScreen extends StatefulWidget {
  ...
  @override
  _SaturDayScheduleScreenState createState() => _SaturDayScheduleScreenState();
}

class _SaturDayScheduleScreenState extends State<SaturDayScheduleScreen> {
  ...
  void _updateSchedule() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Cập nhật thời khóa biểu thứ bảy thành công!')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  void loadSaturdayData() async {
    ...
    if (data != null && data['saturday'] != null) {
      setState(() {
        _subject1.text = data['saturday']['subject1'] ?? '';
        _subject2.text = data['saturday']['subject2'] ?? '';
        _subject3.text = data['saturday']['subject3'] ?? '';
        _subject4.text = data['saturday']['subject4'] ?? '';
        _subject5.text = data['saturday']['subject5'] ?? '';
        _subject6.text = data['saturday']['subject6'] ?? '';
        _subject7.text = data['saturday']['subject7'] ?? '';
        _subject8.text = data['saturday']['subject8'] ?? '';
        _subject9.text = data['saturday']['subject9'] ?? '';
        _subject10.text = data['saturday']['subject10'] ?? '';
        _subject11.text = data['saturday']['subject11'] ?? '';
        _subject12.text = data['saturday']['subject12'] ?? '';
      });
    }
  }
